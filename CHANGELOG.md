...
- 🟢 **O editor no celular virou um aplicativo de desenho** — no celular, o Mural era o mesmo editor do computador só que espremido: cinco faixas empilhadas em cima da arte e dois botões embaixo, sobrando pouco espaço para justamente o que se está montando. Agora a arte ocupa a tela toda, o nome do comunicado subiu para o topo com o "Enviar" ao lado, e as ferramentas ficam numa barra embaixo, uma por ícone — texto, imagem, formas, ícones, modelos, ajustes, condomínio, período e telas —, cada uma abrindo o seu painel. Quando há algo selecionado, a barra troca sozinha para as ações daquele objeto. A IA de melhorar a arte, que estava escondida dentro de Ajustes, virou a primeira entrada da barra.
- 🟢 **Comunicado programado ou já no ar agora pode ser editado pelo síndico** — eram os dois únicos casos sem caminho de volta: a única coisa possível era retirar e começar de novo, e trocar uma data virava chamado. Agora existe "Editar", e ele avisa antes o que vai acontecer: o comunicado sai das telas (ou da programação), volta a ser rascunho e a nova versão passa pela revisão antes de voltar ao ar. Se o sistema das telas não aceitar a retirada, nada muda e a pessoa é avisada — em vez de o Mural dizer "rascunho" para algo que continua passando na tela.
- 🟢 **O que for arrastado para fora da arte não se perde mais** — a área de montagem tem exatamente o tamanho do que vai para a tela, então um texto ou uma imagem puxada para fora sumia de vista sem jeito de pegar de volta. Agora aparece um aviso com quantos itens ficaram de fora e um toque traz todos para dentro. Junto: texto, forma, linha, seta e ícone novos passam a nascer no meio da arte, e não mais no canto de cima, longe do dedo.
- ⚙️ **Tela que está no condomínio mas ficou de fora da programação agora se conserta sozinha** — até agora isso era só um alerta por email, e o alerta não estava dando conta: em 8 de setembro eram 16 prédios e 27 telas nessa situação, o aviso tinha saído duas vezes na vida, e o único prédio anunciado continuava com a tela fora dias depois. Agora o Mural refaz a programação do prédio de hora em hora e inclui a tela que faltava. O email passou a avisar só o que ele não consegue resolver sozinho.
- 🟢 **A planilha de chamados agora sai com a conversa** — quem baixa a planilha de chamados leva junto os comentários de cada um, com autor e data, em ordem. Antes era preciso abrir chamado por chamado para saber o que já tinha sido respondido.
- ⚙️ **Uma pessoa, um acesso, mais de um papel** — quem trabalha aqui e também precisa entrar no Mural como síndico de um prédio precisava de um segundo cadastro, com outro email e outra senha. Agora é um acesso só: na página Conta a pessoa troca a visualização e volta quando quiser, sem digitar senha de novo. Por isso o item do menu que leva até lá passou a se chamar "Conta", e não mais "Alterar Senha" — é por ele que se volta, e o nome antigo escondia o caminho.
- ⚙️ **Quem instalou o condomínio aparece no chamado e na planilha** — quem atende um chamado de tela precisava perguntar no grupo qual empresa cobre aquele condomínio. Agora a empresa, o contato e o telefone aparecem na tela do chamado e na planilha da operação, vindos direto da ficha do edifício no CRM, que continua sendo o único lugar onde esse dado é preenchido — dois cadastros da mesma coisa viveriam divergindo. O síndico não vê essa informação.
- ⚙️ **O número do prédio ficou fácil de copiar** — ele aparecia em cinza embaixo do nome do condomínio na lista de chamados, mas tentar selecioná-lo com o mouse abria o chamado antes de dar tempo de copiar, e dentro do chamado ele não aparecia em lugar nenhum. Agora tem coluna própria e um botão que copia, e também aparece dentro do chamado.
- ⚙️ **Botão para reenviar a programação de um prédio** — quando o Mural está certo e a tela está errada, nenhum dos consertos automáticos alcançava o caso, porque todos comparam o Mural com o próprio Mural e concluíam que estava tudo bem. Um condomínio ficou com os três comunicados fora do ar e, no lugar deles, um vídeo de Dia dos Pais que ninguém daqui tinha enviado. Agora dá para reenviar a programação daquele prédio à operadora sem perguntar nada antes, e o Mural só anota depois que ela aceita.

### Melhorado

- 🟢 **No celular, arrastar um objeto move — não redimensiona** — quem tocava numa imagem ou num texto e arrastava acabava esticando o objeto, porque as alças de tamanho eram grandes demais para o dedo e cobriam quase o objeto inteiro. Agora o dedo pousado sobre o objeto move, e só as quinas continuam redimensionando. No computador nada muda.
- 🟢 **Descer o dedo fecha qualquer painel do editor no celular** — antes era preciso achar o X. Se o dedo pousar numa lista que já estava rolada, o gesto continua sendo dela.
- 🟢 **O editor explica por que um comunicado voltou para a mão do síndico** — comunicado cancelado, ou reaberto de programado/no ar, abre com uma linha dizendo que o envio passa pela revisão de novo; quando o período já venceu, ele aponta que trocar a data pode ser tudo o que falta e leva direto ao calendário.
- ⚙️ **A programação nova é criada antes de a antiga ser cancelada** — era a causa de quase tudo o que deu errado com telas no fim de agosto e início de setembro. Ao renovar a programação de um prédio, o Mural cancelava o que estava no ar e só então pedia a nova: qualquer recusa do sistema das telas nesse intervalo — e são recusas comuns — deixava o prédio sem programação nenhuma. Foi assim que 10 prédios ficaram sem nada em 1º de setembro e outros 3, com 19 telas, em 8 de setembro. Invertida a ordem, a recusa não custa nada: o que está no ar continua no ar e a tentativa se repete depois. Junto vieram três consequências: a renovação nunca mira menos telas do que o prédio já tinha, ela recupera tela que o próprio sistema tinha expulsado antes, e renovação que não acrescenta nada deixou de ser feita.
- ⚙️ **Dois processos não criam mais duas programações para o mesmo prédio** — quando duas rotinas do Mural cuidavam do mesmo prédio ao mesmo tempo, as duas pediam uma programação nova e a operadora criava duas, ocupando em dobro o espaço contratado. Foram 11 casos em 30 dias. Agora a segunda espera a primeira terminar e aproveita o que ela criou.
- ⚙️ **Programação que a operadora criou e o Mural nunca registrou passa a ser encontrada e encerrada** — o painel da operadora mostrava duas programações ocupando espaço num condomínio, uma delas de 10 de julho que o Mural não conhecia: nasceu numa tentativa cuja resposta se perdeu, e ficou dois meses viva porque toda conferência do Mural parte do que ele mesmo anotou. Agora uma verificação diária compara o que foi pedido à operadora com o que ficou registrado, pergunta a ela o que é de cada sobra e encerra o que ainda estiver no ar.
- ⚙️ **Pedido à operadora que volta com erro passageiro é repetido uma vez** — a operadora recusa cerca de 0,1% das chamadas quando recebe muitas de uma vez, sempre nos horários de maior movimento, e a mesma chamada passa segundos depois. Agora ela é refeita automaticamente, exceto nos casos em que repetir poderia criar coisa em dobro do outro lado.
- ⚙️ **Marcar o acordo no cadastro passou a valer na hora** — o campo de acordo do prédio era só uma anotação: até alguém publicar ali, o condomínio continuava veiculando pelo modelo antigo, com uma exibição por comunicado ocupando várias vezes o espaço que o acordo compra uma vez. Agora, salvar o prédio como acordo já converte o condomínio: o Mural monta a exibição única do acordo a partir de um comunicado já aprovado e recolhe as antigas. Prédio de acordo que ainda não tem publicação nenhuma continua esperando a primeira, e uma varredura de hora em hora alcança também os prédios que já estavam marcados antes disso existir.

### Corrigido

- 🟢 **Comunicado tirado do ar continuava rodando na tela** — foi a reclamação de vários condomínios. Quando a ordem de tirar o comunicado da tela era recusada pela operadora — porque o período do prédio estava perto de vencer, ou porque não sobrava nenhum outro comunicado ali —, o Mural dava a remoção por feita mesmo assim, e a rotina que existe justamente para reencontrar esses casos ficava cega, porque ela compara o Mural com o próprio Mural. Um caso chegou a ficar seis dias na tela com o nome de outro condomínio na arte. Agora a remoção só conta como feita quando a operadora confirma, o que ficou pendente é refeito sozinho a cada meia hora, e prédio que fica sem nenhum comunicado tem a programação encerrada de verdade. Pelo mesmo motivo, o pedido de remoção feito pelo síndico deixou de sumir da fila quando a tela respondia que o comunicado ainda estava no ar.
- 🟢 **Vídeo com menos de 10 segundos era recusado sem que ninguém soubesse o porquê** — o material subia com a duração original (8,5 s, 5 s) mas era anunciado como 10 s para a operadora, que recusava o comunicado inteiro; republicar não adiantava. Eram 19 comunicados presos e 66 recusas em 7 dias, um deles reenviado três vezes com o mesmo resultado. Agora o último quadro fica congelado até completar os 10 segundos, e os que estavam presos foram reenviados sozinhos.
- 🟢 **Comunicado marcado como "no ar" e escuro na tela** — dois caminhos diferentes levavam ao mesmo susto. O primeiro: quando uma tela era instalada no condomínio depois de a programação do prédio ter sido feita, ela ficava exibindo só publicidade, para sempre — agora ela entra sozinha na programação. O segundo: comunicado publicado em vários condomínios podia perder a programação de um deles e nunca ser reposto, porque a rotina de reposição olhava todos os estados menos justamente o "no ar". Eram 13 casos, o mais antigo publicado em 19 de junho — um deles passando normalmente em dois condomínios e escuro num terceiro. Agora eles voltam sozinhos.
- ⚙️ **Comunicado republicado ficava parado em "aguardando conferência" para sempre** — quando o material era trocado num comunicado que já estava no ar, o Mural registrava que ele estava em conferência e nenhuma rotina voltava a olhar para ele. Eram 5 comunicados presos, o mais antigo desde 2 de setembro, todos continuando a passar na tela com o material antigo. Corrigido nos três pontos que levavam a isso.
- ⚙️ **Recusa da operadora ao mexer na programação deixava o Mural afirmando o que não aconteceu** — nos seis caminhos que tiram um comunicado da tela, o Mural anotava a mudança antes de pedi-la e engolia a recusa em silêncio; a conferência automática, que compara a anotação com o esperado, então concluía que estava tudo certo e nunca tentava de novo. Num caso de 2 de setembro, 29 pedidos falharam e ninguém soube. Agora o Mural só anota depois do aceite, e uma rotina de hora em hora reencontra e desfaz o que ficou anotado errado.
- ⚙️ **Programação de acordo nascia com um trecho datado de um ano, que passava por cima de tudo** — no primeiro segundo de vida da programação de um prédio, antes de a operadora responder qual período ela concede, o Mural gravava um trecho válido por 12 meses; e trecho datado vale por cima de qualquer remoção, rejeição ou vencimento que venha depois. A verificação achou 703 gravações desse tipo em 367 programações, em 9 dias. A regra agora é uma só e vale para os sete caminhos que mexem nisso.
- ⚙️ **A lista de prédios confundia "telas na operadora" com "comunicados no ar"** — o selo verde da coluna de telas trazia o número e ficava colado na coluna seguinte, então um prédio com 3 telas e nada no ar era lido como "3 comunicados no ar". Um condomínio foi reportado assim para investigação de veiculação quando estava tudo correto — o único comunicado dele tinha vencido na madrugada.
- ⚙️ **Consulta de telas que falha não é mais lida como "a operadora recusou todas"** — quando a consulta dava erro, a resposta vinha vazia, indistinguível de uma recusa real. Isso fazia o Mural abandonar a criação da programação de um prédio em silêncio, e mandar email para a operação dizendo que a operadora tinha recusado uma tela que ela nunca chegou a avaliar. Parte dos prédios apontados como "recusados" pode ser isso.
- ⚙️ **Programação recusada não fica mais tentando de hora em hora** — quando a operadora recusava a renovação, a espera de 24 horas nunca começava a contar, porque ela contava a partir da programação nova, que não chegou a existir. Três prédios ficaram dois dias em laço, com 24 tentativas por dia cada, cada uma gerando consulta, cancelamento e email.
- ⚙️ **A recusa da operadora ao cancelar uma exibição era anotada como aceite** — de todas as conversas que o Mural tem com a operadora, a de cancelar era a única que não olhava a resposta: a recusa chegava e era registrada como sucesso, e logo depois o Mural marcava a exibição como encerrada, apagando o "está no ar" que a operadora tinha acabado de dizer. Como é justamente esse campo que as duas rotinas de caça usam, a exibição saía do radar no mesmo instante e para sempre. Num condomínio isso durou de 5 a 11 de setembro: a exibição "cancelada" renovou sozinha a semana, seguiu reservando as duas telas com um comunicado vencido e deixou o prédio ocupando dois espaços no lugar de um.
- ⚙️ **Exibição que a operadora se recusa a informar passa a contar como viva** — quando a resposta era "não posso ler essa", o Mural tratava como "não sei" e não fazia nada, que é o desfecho mais caro, porque deixa a exibição no ar. A conferência do dia 11 fechou a conta: das 1.024 exibições que o Mural dava como encerradas, 1.013 estavam mesmo mortas e as 11 que responderam assim estavam **todas** veiculando; sete delas dividiam o espaço do prédio com outra exibição. Agora essas são encerradas sozinhas, mantidas as duas travas de sempre — nunca a exibição que o prédio usa agora, nunca a que carrega comunicado dentro do prazo.
- ⚙️ **Prédio que vira acordo ficava com as exibições antigas veiculando junto da nova** — antes do acordo, cada comunicado ganha a sua própria exibição; marcar o acordo só mudava o caminho das publicações seguintes, e nada olhava para as que já estavam no ar. O condomínio passava a ter a do acordo **mais** todas as antigas que ainda não tinham vencido — num deles eram três ao mesmo tempo, com metade do espaço do prédio entregue a um comunicado só. Nenhuma varredura pegava, porque todas caçam exibição que o Mural já dá como encerrada, e estas estavam vivas e certas dos dois lados. Eram 8 prédios e 11 exibições a recolher. Agora os comunicados são levados para a exibição do acordo e só então as antigas são encerradas — nessa ordem, para nenhum comunicado ficar sem tela no meio do caminho.
- ⚙️ **O conserto da programação estava sendo morto pelo tamanho da frota** — a rotina que conserta as programações rodava depois de uma varredura que consulta um a um os prédios de acordo. Com a frota chegando a 949 exibições, a varredura passou a consumir quase todo o tempo que a rotina tem para rodar, e o conserto simplesmente não chegava a acontecer: ficaram 22 horas sem uma linha de registro e sem nenhum aviso. Foi assim que um condomínio amanheceu com o comunicado marcado como "Finalizado" no Mural e ainda rodando na tela — a operadora recusou a retirada às 3 da manhã, o Mural fez o certo e deixou o caso para o ciclo seguinte, e o ciclo seguinte não existia mais. Eram 30 prédios com comunicado vencido ainda na programação. Agora o conserto tem horário próprio, e as duas rotinas param antes do teto e **avisam** quando não deram conta da frota inteira — foi o silêncio que fez isso custar caro.

### Interno

- ⚙️ **Publicação de vídeo voltou a funcionar no servidor** — desde 3 de setembro a junção do texto com o vídeo acontece no servidor, mas o programa que faz isso não estava indo junto no que é publicado, e toda publicação que passava por ele falhava. Foram 29 falhas num único dia e um comunicado preso desde 3 de setembro.
- ⚙️ **O registro do que foi pedido à operadora deixou de ser apagado** — os pedidos de criar e de encerrar programação eram descartados depois de 30 dias, e são a única memória que temos disso: a operadora não tem como listar o que existe na conta. Sem esse registro, a programação de julho que ficou sobrando era invisível.
...
- 🟢 **O editor diz quanto texto cabe na fala do apresentador** — no comunicado em que um apresentador lê a mensagem, o vídeo tem 10 segundos fixos e não havia como adivinhar quanto texto cabe neles. A tela pedia "entre 100 e 125 caracteres", números que nunca foram medidos e que contavam só o texto principal, deixando de fora a abertura com o nome do condomínio. Agora o editor orienta enquanto o síndico escreve: quanto falta para o tamanho ideal, quando vai sobrar tela parada no fim e quanto passou do limite. Os números saíram da medição dos comunicados já publicados — 135 caracteres, contando a abertura, é o ponto em que a fala quase sempre cabe e quase sempre preenche os 10 segundos.

### Melhorado

- 🟢 **O aviso de item fora do quadro sai da frente do comunicado** — o aviso de que algo foi arrastado para fora da arte fica por cima do desenho, e agora dá para recolhê-lo num toque: ele vira uma marca pequena com a contagem no canto, e outro toque o traz de volta inteiro. Ele volta a nascer aberto quando o item é trazido para dentro ou ao trocar de tela, para que nada fique esquecido lá fora sem ninguém para lembrar dele.

### Corrigido

- 🟢 **O apresentador falava só parte da mensagem, e o fim era cortado** — o comunicado ia para a tela com a frase picada no meio da palavra, e a legenda mostrava a palavra que a voz não terminava. Olhando os 117 vídeos já publicados, 40 deles (34%) terminavam com a fala ainda em curso. Duas causas somadas: a conta de caracteres deixava de fora a abertura com o nome do condomínio, que estava preenchida em 49 dos 60 últimos pedidos; e o ritmo da fala não é constante — variou de 10,7 a 16,5 caracteres por segundo nos mesmos vídeos, então um texto curto podia estourar enquanto um mais longo cabia, e nenhum limite fixo de caracteres resolve isso. Agora a fala que passa um pouco dos 10 segundos é acelerada até 12%, sem mudar o timbre da voz, em vez de decepada; e só quando nem isso resolve o síndico é avisado de quantos caracteres tirar.
- 🟢 **Quem acessa o Mural de fora do Brasil não conseguia criar comunicado** — o Mural montava o período pelo dia do país de quem estava clicando, e não pelo dia de Brasília, que é o dia em que a tela do prédio exibe. Escolher "hoje" de Portugal caía no dia anterior e a tentativa era recusada, toda vez. O síndico de um condomínio, morando em Portugal, não tinha um único comunicado criado. Agora o dia é sempre o de Brasília — no editor, no agendamento e no calendário, que mostrava o período terminando um dia depois do que termina. Junto: quando o Mural recusa um comunicado, ele passa a dizer o motivo, em vez do "Erro ao salvar" mudo que aparecia para qualquer recusa.
- 🟢 **Vídeo que não publicava de jeito nenhum** — um comunicado em vídeo não ia para a tela e o aviso dizia que o sistema das telas tinha recusado o material, quando na verdade o arquivo nem chegava a sair daqui: o vídeo trazia uma informação de cor inválida, que os tocadores comuns ignoram e o preparo do Mural não. Agora o Mural conserta essa informação sozinho, sem recomprimir nem perder qualidade; e quando não consegue preparar o vídeo, ele diz isso e pede outro arquivo, em vez de acusar o sistema das telas por algo que não foi ele. Dos 829 vídeos publicados nos últimos 120 dias, só esse tinha o problema.
- ⚙️ **Comunicado encerrado voltou a poder ser publicado pela edição** — quem abria pelo "Editar" um comunicado já encerrado recebia um aviso de situação inválida e não tinha saída por ali: era preciso voltar à lista e devolvê-lo à revisão antes. Agora o próprio editor faz isso, e a passagem não é formalidade — é ela que descarta a arte da veiculação anterior; sem ela, a republicação mandaria a arte antiga de volta para a tela. Junto, aprovar passou a salvar antes de publicar: quem abre um comunicado encerrado abre justamente para trocar a data vencida, e essa data nova só era guardada pelo salvamento automático de 30 em 30 segundos — o mesmo valia para título, desenho e prédios mexidos na revisão.
- ⚙️ **Programação de prédio de acordo que nascia sem reservar tela nenhuma** — um condomínio agendou um comunicado em 12 de setembro e ele nunca foi à tela. A programação existia e estava viva, mas não tinha reservado uma tela sequer, e nada do nosso lado acusava: o comunicado ficou dois dias como "agendado" para o síndico. Eram dois furos somados. Ao criar, o Mural perguntava à operadora quais telas estavam disponíveis e, quando a resposta vinha vazia, pedia a programação assim mesmo com todas as telas — pedido que a operadora aceita sem reservar nada. E, ao conferir, ele só anotava a reserva quando ela vinha preenchida, ou seja, ignorava justamente o caso "reservou zero". Agora a criação para quando não há tela para reservar, e o email de conferência passa a relatar quantas telas foram pedidas e quantas ficaram de fato reservadas.
